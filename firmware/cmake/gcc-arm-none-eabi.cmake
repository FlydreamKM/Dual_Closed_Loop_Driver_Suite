...
# 尝试从 CMAKE_C_COMPILER 推断工具链 bin 目录（解决 VS Code / cube-cmake 下 objcopy 找不到的问题）
get_filename_component(_C_COMPILER_DIR "${CMAKE_C_COMPILER}" DIRECTORY)
if(_C_COMPILER_DIR)
    set(CMAKE_OBJCOPY               "${_C_COMPILER_DIR}/${TOOLCHAIN_PREFIX}objcopy.exe")
    set(CMAKE_SIZE                  "${_C_COMPILER_DIR}/${TOOLCHAIN_PREFIX}size.exe")
else()
